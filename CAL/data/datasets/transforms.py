...
class GroupRandomHorizontalFlip(object):
    """Randomly horizontally flips the given PIL.Image with a probability of p
    """
    def __init__(self, p):
        self.p = p
...
class GroupPad(object):
    """ Pad the input PIL.Image on all sides with given "pad" value.
    """

    def __init__(self, pad):
        self.worker = torchvision.transforms.Pad(pad)
